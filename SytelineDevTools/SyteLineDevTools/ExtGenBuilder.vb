...
Public Class ExtGenBuilder
    ...
    Public Function BuildExtGen(Site As String, Name As String, IsEXTGEN As Boolean, lSPParameters As List(Of SPParameter), lExecuteParms As List(Of Object)) As String
        Dim oInfobarParameter As SPParameter = Nothing
        Dim sbSQL As New StringBuilder
        sbSQL.Append("Create PROCEDURE [dbo].[")
        If IsEXTGEN Then
            sbSQL.Append("EXTGEN_")
        Else
            sbSQL.Append("WRAPPER_")
        End If
        sbSQL.Append(String.Format("{0}] (", Name))
        ...
        If oInfobarParameter IsNot Nothing And IsEXTGEN Then
        ...
        End If
        sbSQL.Append(vbCrLf)
        sbSQL.Append(vbCrLf & "--Preprocessing START Here")
        sbSQL.Append(vbCrLf)
        sbSQL.Append(vbCrLf & "--Preprocessing END Here")
        sbSQL.Append(vbCrLf)
        ...
        sbSQL.Append(vbCrLf)
        sbSQL.Append(vbCrLf & "--Post processing START Here")
        sbSQL.Append(vbCrLf)
        sbSQL.Append(vbCrLf & "--Post processing END Here")
        sbSQL.Append(vbCrLf)
